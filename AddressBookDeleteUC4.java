...
public class AddressBookDeleteUC4 {

public static void main(String[] args) {

		System.out.println("Welcome to Address Book");

		List<AddressBookDeleteUC4> persons = new ArrayList<>();
		...
		if (userChoice == 0) {
			...
			for (int i = 0; i < noOfPersons; i++) {
				AddressBookDeleteUC4 contact = new AddressBookDeleteUC4();
			...
			if (userChoice2 == 0) {
				...
				for (AddressBookDeleteUC4 i : persons) {
