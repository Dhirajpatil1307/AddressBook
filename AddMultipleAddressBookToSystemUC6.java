...
public class AddMultipleAddressBookToSystemUC6 {

	public static void main(String[] args) {

		System.out.println("Welcome to Address Book");
		System.out.println("Add multiple contacst");
		List<AddMultipleAddressBookToSystemUC6> persons = new ArrayList<>();
		...
		if (userChoice == 0) {
			...
			for (int i = 0; i < noOfPersons; i++) {
				AddMultipleAddressBookToSystemUC6 contact = new AddMultipleAddressBookToSystemUC6();
			...
			if (userChoice2 == 0) {
				...
				for (AddMultipleAddressBookToSystemUC6 i : persons) {
