...
public class AddMultipleContactsUC5 {

	public static void main(String[] args) {

		System.out.println("Welcome to Address Book");
		System.out.println("Add multiple contacst");
		List<AddMultipleContactsUC5> persons = new ArrayList<>();
		...
		if (userChoice == 0) {
			...
			for (int i = 0; i < noOfPersons; i++) {
				AddMultipleContactsUC5 contact = new AddMultipleContactsUC5();
			...
			if (userChoice2 == 0) {
				...
				for (AddMultipleContactsUC5 i : persons) {
