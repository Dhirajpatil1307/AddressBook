...
public class UpdateYourContactDetailsUC3 {

	public static void main(String[] args) {

		System.out.println("Welcome to Address Book");

		List<UpdateYourContactDetailsUC3> persons = new ArrayList<>();
		...
		if (userChoice == 0) {
			...
			for (int i = 0; i < noOfPersons; i++) {
				UpdateYourContactDetailsUC3 contact = new UpdateYourContactDetailsUC3();
			...
			if (userChoice2 == 0) {
				...
				for (UpdateYourContactDetailsUC3 i : persons) {
